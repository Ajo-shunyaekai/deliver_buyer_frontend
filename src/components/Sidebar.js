...
const Sidebar = ({ children, dragWindow }) => {
    ...
    const DrawerList = (
        <Box sx={{ width: 250 }} role="presentation" onClick={toggleDrawer(true)} >
            ...
            <Link to="/buy" className={styles.sidebar_text} activeclassname={styles.active}>
                ...
                <div className={styles.mobile_order_btn}>
                    ...
                    {isDropdown && (
                        <div className={styles.accordion_content}>
                            <Link to="/alotted-order" className={styles.sidebar_text} activeclassname={styles.active} style={{ width: '170px' }}>
            ...
            < div div className={styles.sidebar_container} >
                {
                    isIcon ? <div style={{ width: isOpen ? "200px" : "50px" }
                        ...
                        <div className={styles.mobile_order_btn}>
                            ...
                            {isDropdown && isOpen && (
                                <div className={styles.accordion_content}>
                                    <Link to="/alotted-order" className={styles.sidebar_text} activeclassname={styles.active} style={{ width: '160px' }}>
